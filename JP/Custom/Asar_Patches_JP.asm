; Note: Put your custom routine/data macros, references to them, and defines in this file from within the JP_InsertIntegratedPatches and JP_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro JP_InsertIntegratedPatches()
...
macro JP_ApplyPatchesPostAssembly()
